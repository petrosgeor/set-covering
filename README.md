...
with configuration and environment tests. The transformer encoder and GRU pointer
policy for PPO are a proposed architecture; the model and its training are not
implemented yet.
